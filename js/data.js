...
const TRANSLATIONS = {
    nl: {
        ...
        'filters.all_neighborhoods': 'Alle buurten',
        ...
        'toast.favorite_added': 'Toegevoegd aan favorieten',
        ...
        'install.status_pending': 'Controleer installatie-opties...',
        'install.toast_title': 'Installeer Fun-da',
        ...
        'toast.link_copied': 'Link gekopieerd!',
        ...
        'qr.manual_entry_required': 'QR scannen wordt op dit apparaat niet ondersteund. Voer de code handmatig in.',
        'qr.modal_title': 'QR Code Scannen',
        'qr.recognized': 'QR code herkend!',
        'detail.view_on_funda': 'Bekijk op Funda',
        'placeholder.search_area': 'bijv. Amsterdam, Victorieplein, 1071',
        'placeholder.min_price': 'Min €',
        'placeholder.max_price': 'Max €',
        'placeholder.min_size': 'Min',
        'placeholder.max_size': 'Max',
        'placeholder.min_year': 'bijv. 1990',
        'placeholder.min_days_custom': 'of typ eigen getal',
        'placeholder.max_days_example': 'bijv. 14',
        'placeholder.family_name': 'Bijv. Papa, Mama, Sophie...',
        'placeholder.family_code': 'bijv. fd-1a2b-3c4d-5e6f-7a8b-9c0d',
        'a11y.settings': 'Instellingen',
        'a11y.family_matches': 'Familie matches',
        'a11y.favorites': 'Favorieten',
        'a11y.profile': 'Profiel',
        'a11y.nope': 'Nee',
        'a11y.more_info': 'Meer info',
        'a11y.like': 'Ja!',
        'a11y.filters': 'Filters',
        'a11y.close_filters': 'Sluit filters',
        'a11y.select_period': 'Zoekperiode selecteren',
        'a11y.min_price': 'Minimum prijs',
        'a11y.max_price': 'Maximum prijs',
        'a11y.min_size': 'Minimum woonoppervlak',
        'a11y.max_size': 'Maximum woonoppervlak',
        'a11y.choose_neighborhood': 'Kies een buurt',
        'a11y.min_year': 'Bouwjaar vanaf',
        'a11y.min_days_on_market': 'Minimum dagen op de markt',
        'a11y.max_days_on_market': 'Maximum dagen op de markt',
        'a11y.refresh_listings': 'Ververs woningen',
        'a11y.sort_by': 'Sorteer op',
        'a11y.list_layout': 'Lijst',
        'a11y.grid_layout': 'Raster',
        'a11y.close_favorites': 'Sluit favorieten',
        'a11y.share': 'Delen',
        'a11y.close_details': 'Sluit details',
        'a11y.close_settings': 'Sluit instellingen',
        'a11y.close_bin': 'Sluit prullenbak',
        'a11y.close_family': 'Sluit familie modus',
        'a11y.family_name': 'Jouw naam',
        'a11y.family_code': 'Familiecode',
        'a11y.close_share_code': 'Sluit deelcode',
        'a11y.close_qr_scanner': 'Sluit QR scanner',
        'a11y.close_map': 'Sluit kaart',
        'a11y.map': 'Kaart',
    },
    en: {
        'nav.swipe': 'Swipe',
        ...
        'filters.all_neighborhoods': 'All neighborhoods',
        ...
        'install.status_pending': 'Checking installation options...',
        'install.toast_title': 'Install Fun-da',
        ...
        'qr.manual_entry_required': 'QR scanning is not supported on this device. Enter the code manually.',
        'qr.modal_title': 'Scan QR Code',
        'qr.recognized': 'QR code recognized!',
        'detail.view_on_funda': 'View on Funda',
        'placeholder.search_area': 'e.g. Amsterdam, Victorieplein, 1071',
        'placeholder.min_price': 'Min €',
        'placeholder.max_price': 'Max €',
        'placeholder.min_size': 'Min',
        'placeholder.max_size': 'Max',
        'placeholder.min_year': 'e.g. 1990',
        'placeholder.min_days_custom': 'or enter your own number',
        'placeholder.max_days_example': 'e.g. 14',
        'placeholder.family_name': 'e.g. Dad, Mom, Sophie...',
        'placeholder.family_code': 'e.g. fd-1a2b-3c4d-5e6f-7a8b-9c0d',
        'a11y.settings': 'Settings',
        'a11y.family_matches': 'Family matches',
        'a11y.favorites': 'Favorites',
        'a11y.profile': 'Profile',
        'a11y.nope': 'No',
        'a11y.more_info': 'More info',
        'a11y.like': 'Yes!',
        'a11y.filters': 'Filters',
        'a11y.close_filters': 'Close filters',
        'a11y.select_period': 'Select search period',
        'a11y.min_price': 'Minimum price',
        'a11y.max_price': 'Maximum price',
        'a11y.min_size': 'Minimum living area',
        'a11y.max_size': 'Maximum living area',
        'a11y.choose_neighborhood': 'Choose a neighborhood',
        'a11y.min_year': 'Year built from',
        'a11y.min_days_on_market': 'Minimum days on market',
        'a11y.max_days_on_market': 'Maximum days on market',
        'a11y.refresh_listings': 'Refresh listings',
        'a11y.sort_by': 'Sort by',
        'a11y.list_layout': 'List',
        'a11y.grid_layout': 'Grid',
        'a11y.close_favorites': 'Close favorites',
        'a11y.share': 'Share',
        'a11y.close_details': 'Close details',
        'a11y.close_settings': 'Close settings',
        'a11y.close_bin': 'Close recycle bin',
        'a11y.close_family': 'Close family mode',
        'a11y.family_name': 'Your name',
        'a11y.family_code': 'Family code',
        'a11y.close_share_code': 'Close share code',
        'a11y.close_qr_scanner': 'Close QR scanner',
        'a11y.close_map': 'Close map',
        'a11y.map': 'Map',
    },
};
